...
<form id="personalForm" class="layui-form" action="" method="post" lay-filter="test1" style="width: 800px">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input disabled type="text" name="securityId" required lay-verify="required" placeholder=""
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input id="securityName" type="text" name="securityName" required lay-verify="required" placeholder=""
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input disabled type="text" name="securityPhone" required lay-verify="required" placeholder=""
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="password" name="securityPwd" required lay-verify="required" placeholder="" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input disabled type="text" name="securityStateName" required lay-verify="required" placeholder=""
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input disabled type="text" name="securityRegtime" required lay-verify="required" placeholder=""
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input disabled type="text" id="securitySex" name="securitySex" required lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input id="securityAge" type="text" name="securityAge" required lay-verify="required" placeholder=""
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input id="securityAdd" type="text" name="securityAdd" required lay-verify="required" placeholder=""
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
