            ...
            <div class="layui-card">
                <div class="layui-card-body demoTable">
                    <div class="layui-inline layui-show-xs-block">
                        <input type="text" name="rectorName" lay-verify="required" id="rectorName" placeholder="请输入用户名" autocomplete="off"
                               class="layui-input">
                    </div>
                    <div class="layui-inline layui-show-xs-block">
...
<script>
    layui.use(['laydate', 'form', 'laypage', 'table', 'laytpl','util'], function () {
        ...
        table.render({
            ...
            id: 'listReload',
            page: true
            , url:"/platformController/selectParents?roleID="+6//数据接口?roleID="+5
            // ,cellMinWidth: 80 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
            , cols: [[
               ,{field: 'rectorId', title: 'id', fixed: 'left', hide: "true" }
                , {field: 'rectorName', title: '用户名'}
                , {field: 'rectorPwd', title: '密码'}
        ...
        table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'ban') { //删除
                ...
                $.ajax({
                    ...
                    asnyc: true,
                    type: "Post",
                    data: "id=" + data.rectorId + "&type=" + 2+"&roleId="+6,
                    dataType: "text",
                ...
                $.ajax({
                    ...
                    asnyc: true,
                    type: "Post",
                    data: "id=" + data.rectorId + "&type=" + 1+"&roleId="+6,
                    dataType: "text",
                    success: function (msg) {
                        layer.msg("修改成功"),
                            location.reload();
