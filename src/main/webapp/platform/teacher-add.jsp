                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="teacherTel" name="teacherTel" required="" lay-verify="required|phone" autocomplete="off" class="layui-input"></div>
...
<%--                    </div>--%>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="teacherName" name="teacherName" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="teacherPwd" class="layui-form-label">
                            <span class="x-red">*</span>密码</label>
                        <div class="layui-input-inline">
                            <input type="password" id="teacherPwd" name="teacherPwd" required="" lay-verify="pass" autocomplete="off" class="layui-input"></div>
                        <div class="layui-form-mid layui-word-aux">3到16个字符</div></div>
                    <div class="layui-form-item">
                        <label for="male" class="layui-form-label">
                            <span class="x-red">*</span>性别</label>
                        <div class="layui-input-inline">
                            <input type="radio" id="male" checked="checked" name="teacherSex" value="男">男
                            <input type="radio" id="female" name="teacherSex" value="女">女
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="teacherAge" name="teacherAge" required="" lay-verify="teacherAge" autocomplete="off" class="layui-input"></div>
        ...
        <script>
            ...
            function() {
                ...
                form.on('submit(add)',function(data) {
                    ...
                    //发异步，把数据提交给php
                    $.ajax({
                        url:"/platformController/insertTeacher",
                        type:"post",
                        asnyc:true,//异步
