            ...
            <div class="layui-row">
                <form class="layui-form">
                    <div class="layui-form-item">
                        <label for="rectorTel" class="layui-form-label">
                            <span class="x-red">*</span>手机号</label>
                        <div class="layui-input-inline">
                            <input type="text" id="rectorTel" name="rectorTel" required="" lay-verify="required|phone" autocomplete="off" class="layui-input"></div>
...
<%--                    </div>--%>
                    <div class="layui-form-item">
                        <label for="rectorName" class="layui-form-label">
                            <span class="x-red">*</span>昵称</label>
                        <div class="layui-input-inline">
                            <input type="text" id="rectorName" name="rectorName" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="rectorPwd" class="layui-form-label">
                            <span class="x-red">*</span>密码</label>
                        <div class="layui-input-inline">
                            <input type="password" id="rectorPwd" name="rectorPwd" required="" lay-verify="pass" autocomplete="off" class="layui-input"></div>
                        <div class="layui-form-mid layui-word-aux">3到16个字符</div></div>
                    <div class="layui-form-item">
                        <label for="male" class="layui-form-label">
                            <span class="x-red">*</span>性别</label>
                        <div class="layui-input-inline">
                            <input type="radio" id="male" checked="checked" name="rectorSex" value="男">男
                            <input type="radio" id="female" name="rectorSex" value="女">女
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="rectorAge" class="layui-form-label">
                            <span class="x-red">*</span>年龄</label>
                        <div class="layui-input-inline">
                            <input type="text" id="rectorAge" name="rectorAge" required="" lay-verify="teacherAge" autocomplete="off" class="layui-input"></div>
        ...
        <script>
            ...
            layui.use(['form', 'layer', 'layedit', 'laydate', 'upload', "jquery", "pca"],
                ...
                form.on('submit(add)',function(data) {
                    ...
                    var rectorSex=$('input[name="rectorSex"]:checked').val();
                    var rectorAge=$("#rectorAge").val();
                    // console.log(studentSex)
                    var address = document.getElementById("address").value;
                    var province = document.getElementById("province").value;
                    var city = document.getElementById("city").value;
                    var area = document.getElementById("area").value;
                    var rectorAdd= province + city + area + address;
                    var rectorTel=$("#rectorTel").val();
                    var rectorPwd=$("#rectorPwd").val();
                    //发异步，把数据提交给php
                    $.ajax({
                        url:"/platformController/insertRector",
                        type:"post",
                        asnyc:true,//异步
