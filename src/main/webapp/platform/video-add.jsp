...
<%--                            <input type="file" id="securityPhone" name="securityPhone" required="" lay-verify="required|phone" autocomplete="off" class="layui-input">--%>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="safetyVideoName" name="safetyVideoName" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="videoName" class="layui-form-label">
                            <span class="x-red">*</span>文件名称</label>
                        <div class="layui-input-inline">
                            <input type="text" id="videoName" name="videoName" required="" lay-verify="pass" autocomplete="off" class="layui-input"></div>
                       </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">设置时间</label>
                        <div class="layui-inline layui-show-xs-block">
                            <input class="layui-input " autocomplete="off" placeholder="开始日" name="safetyVideoStar" id="safetyVideoStar">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                            <input class="layui-input" autocomplete="off" placeholder="截止日" name="safetyVideoEnd" id="safetyVideoEnd">
                        </div>
                    </div>
                    <div class="layui-form-item">
...
<%--                        <button type="button" class="layui-btn" id="test9">开始上传</button>--%>
                        <button class="layui-btn" lay-filter="add" lay-submit="">取消</button></div>
                </form>
            </div>
        </div>
        <script>
