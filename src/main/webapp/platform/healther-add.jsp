            ...
            <div class="layui-row">
                <form class="layui-form">
                    <div class="layui-form-item">
                        <label for="healtherPhone" class="layui-form-label">
                            <span class="x-red">*</span>手机号</label>
                        <div class="layui-input-inline">
                            <input type="text" id="healtherPhone" name="healtherPhone" required="" lay-verify="required|phone" autocomplete="off" class="layui-input"></div>
...
<%--                    </div>--%>
                    <div class="layui-form-item">
                        <label for="healtherName" class="layui-form-label">
                            <span class="x-red">*</span>昵称</label>
                        <div class="layui-input-inline">
                            <input type="text" id="healtherName" name="healtherName" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="healtherPwd" class="layui-form-label">
                            <span class="x-red">*</span>密码</label>
                        <div class="layui-input-inline">
                            <input type="password" id="healtherPwd" name="healtherPwd" required="" lay-verify="pass" autocomplete="off" class="layui-input"></div>
                        <div class="layui-form-mid layui-word-aux">3到16个字符</div></div>
                    <div class="layui-form-item">
                        <label for="male" class="layui-form-label">
                            <span class="x-red">*</span>性别</label>
                        <div class="layui-input-inline">
                            <input type="radio" id="male" checked="checked" name="healtherSex" value="男">男
                            <input type="radio" id="female" name="healtherSex" value="女">女
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="healtherAge" class="layui-form-label">
                            <span class="x-red">*</span>年龄</label>
                        <div class="layui-input-inline">
                            <input type="text" id="healtherAge" name="healtherAge" required="" lay-verify="teacherAge" autocomplete="off" class="layui-input"></div>
                        <div class="layui-form-mid layui-word-aux"></div></div>
<%--                    <div class="layui-form-item">--%>
<%--                        <label for="healtherAdd" class="layui-form-label">--%>
<%--                            <span class="x-red">*</span>地址</label> //地址栏可以进行省市级三级联--%>
<%--                        <div class="layui-input-inline">--%>
<%--                            <input type="text" id="healtherAdd" name="healtherAdd" required="" &lt;%&ndash;lay-verify=" "&ndash;%&gt; autocomplete="off" class="layui-input"></div>--%>
        ...
        <script>
            ...
            layui.use(['form', 'layer', 'layedit', 'laydate', 'upload', "jquery", "pca"],
                ...
                form.on('submit(add)',function(data) {
                    ...
                    var healtherSex=$('input[name="healtherSex"]:checked').val();
                    var healtherAge=$("#healtherAge").val();
                    // console.log(studentSex)
                    var address = document.getElementById("address").value;
                    var province = document.getElementById("province").value;
                    var city = document.getElementById("city").value;
                    var area = document.getElementById("area").value;
                    var healtherAdd= province + city + area + address;
                    var healtherPhone=$("#healtherPhone").val();
                    var healtherPwd=$("#healtherPwd").val();

                    //发异步，把数据提交给php
                    $.ajax({
                        url:"/platformController/insertHealther",
                        type:"post",
                        asnyc:true,//异步
