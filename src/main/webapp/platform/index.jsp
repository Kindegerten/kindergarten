...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><%--解析el表达式--%>
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <%--<dd>
                            <button data-method="notice" class="layui-btn">修改密码</button></dd>--%>
                        <dd>
        ...
        <div class="left-nav">
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="${i.menuName}">&#xe6b8;</i>
                            <cite>${i.menuName}</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <c:forEach var="j" items="${i.menus}">
                            <li>
                                <a onclick="xadmin.add_tab('${j.menuName}','${j.menuUrl}')">
                                    <i class="iconfont">&#xe6a7;</i>
