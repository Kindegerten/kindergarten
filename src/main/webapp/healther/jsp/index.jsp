...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="保健员管理">&#xe6b8;</i>
                    <cite>保健员管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('体检管理','${pageContext.request.contextPath}/healther/jsp/bodyCheck-list.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>体检管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('膳食管理','${pageContext.request.contextPath}/healther/jsp/meal-list.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>膳食管理</cite></a>
                    </li>
                </ul>
