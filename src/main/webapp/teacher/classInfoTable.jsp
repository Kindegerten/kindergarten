...
<%--宝宝图片--%>
        <div class="layui-inline">
            <div class="layui-input-block">
                <img src="" id="faceUrl" class="layui-nav-img" style="height: 150px;width: 150px">
            </div>
        </div>
<%--宝宝信息--%>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="babyName" id="babyName" placeholder="" class="layui-input" disabled="disabled">
            </div>
            <label class="layui-form-label">宝宝年龄：</label>
            <div class="layui-input-block">
                <input type="text" name="babyAge" id="babyAge" placeholder="" class="layui-input" disabled="disabled">
            </div>
            <label class="layui-form-label">宝宝性别：</label>
            <div class="layui-input-block">
                <input type="text" name="babySex" id="babySex" placeholder="" class="layui-input" disabled="disabled">
            </div>
            <label class="layui-form-label">注册时间：</label>
            <div class="layui-input-block">
                <input type="text" name="admissionTime" id="admissionTime" placeholder="" class="layui-input"
...
<%--家长图片--%>
    <div>
        <div class="layui-inline">
            <div class="layui-input-block">
                <img src="" id="photoUrl" class="layui-nav-img" style="height: 150px;width: 150px">
            </div>
        </div>
<%--家长信息--%>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="parentsAge" id="parentsAge" placeholder="" class="layui-input" disabled="disabled">
            </div>
            <label class="layui-form-label">家长性别：</label>
            <div class="layui-input-block">
                <input type="text" name="parentsSex" id="parentsSex" placeholder="" class="layui-input" disabled="disabled">
            </div>
    ...
    layui.use(['form', 'table', 'jquery', 'layedit', 'laydate', 'upload'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'babyId', width: 100, title: '宝宝编号'},
                {field: 'babyName', width: 100, title: '宝宝名称'},
                {field: 'parentsName', width: 100, title: '家长名称'},
                {field: 'admissionTime', width: 180, title: '入学时间', sort: true},
                {field: 'babySex', width: 120, title: '性别', sort: true},
                {title: '宝宝信息', minWidth: 150, toolbar: '#currentTableBar', align: "center"},
                {field: 'faceUrl', width: 100, title: '宝宝图片', hide: true},

                {field: 'parentsSex', width: 100, title: '家长性别', hide: true},
